...
export default class Select extends Component {
  ...
  static propTypes = {
    ...
    selectTestID: React.PropTypes.string,
    optionListTestID: React.PropTypes.string
  };
  ...
  render() {
    ...
    return (
      <View>
        <TouchableWithoutFeedback onPress={this.onPress.bind(this)} testID={selectTestID}>
